...
//	private Container cc = this.getContentPane();
//
//	prac() {
//		initcomponents();
//	}
...
//		// cc.setBackground(Color.yellow); // color container r mddhe dite hbe
//	}

	public static void main(String[] args) {
		prac frame = new prac(); // Jframe extends kr enile ekhane class r obj create krlei hbe
